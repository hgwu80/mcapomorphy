context("Testing parse.R")

setwd('../..');



test_that("Testing parse_genome", {
    ...
    expect_true(identical(parse_genome('data-raw/genome55342.html'), parse_genome_55342));
    ...
    expect_true(identical(parse_genome('data-raw/genome2793.html'), parse_genome_2793));
});
